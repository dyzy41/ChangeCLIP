...
dataset_path = "/home/ps/HDD/zhaoyq_data/DATASET/LEVIR-CD/cut_data"  # 将此处替换为您的数据集路径
output_path = "/home/ps/HDD/zhaoyq_data/DATASET/LEVIR-CD/cut_data"  # 将此处替换为您想要保存txt文件的输出路径
