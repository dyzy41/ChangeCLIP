...
bash tools/dist_train.sh configs/0cd_ce/changeclip_levir.py 2 --work-dir work_dirs_ce/changeclip_levir
bash tools/test.sh LEVIR configs/0cd_ce/changeclip_levir.py 2 work_dirs_ce/changeclip_levir

bash tools/dist_train.sh configs/0cd_ce/changeclip_levir_vit.py 2 --work-dir work_dirs_ce/changeclip_levir_vit
bash tools/test.sh LEVIR configs/0cd_ce/changeclip_levir_vit.py 2 work_dirs_ce/changeclip_levir_vit
...
bash tools/dist_train.sh configs/0cd_ce/changeclip_cdd.py 2 --work-dir work_dirs_ce/changeclip_cdd
bash tools/test.sh CDD configs/0cd_ce/changeclip_cdd.py 2 work_dirs_ce/changeclip_cdd

bash tools/dist_train.sh configs/0cd_ce/changeclip_cdd_vit.py 2 --work-dir work_dirs_ce/changeclip_cdd_vit
bash tools/test.sh CDD configs/0cd_ce/changeclip_cdd_vit.py 2 work_dirs_ce/changeclip_cdd_vit